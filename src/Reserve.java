		...
		public void searchSeat() { //예약조회 메소드
			...
			for(int i = 0; i<Corona19.h1.rl.size(); i++) {
				...
				if(Corona19.h1.rl.get(i).getPhoneNum().substring(9).equals(find)) {
					tf = false;
					System.out.println("------------------------------------------------------------------------");
					System.out.println("예약자: " +Corona19.h1.rl.get(i).getName()+"님 " + "\t예약병원: " + Corona19.h1.name + "\t\t예약일: " + Corona19.h1.rl.get(i).getDayNum() + "\t전화번호: " + Corona19.h1.rl.get(i).getPhoneNum());
					System.out.println("------------------------------------------------------------------------");
			...
			for(int i = 0; i<Corona19.h2.rl.size(); i++) {
				...
				if(Corona19.h2.rl.get(i).getPhoneNum().substring(9).equals(find)) {
					...
					System.out.println("------------------------------------------------------------------------");
					System.out.println("예약자: " +Corona19.h2.rl.get(i).getName()+"님 " + "\t예약병원: " + Corona19.h2.name + "\t\t예약일: " + Corona19.h2.rl.get(i).getDayNum() + "\t전화번호: " + Corona19.h2.rl.get(i).getPhoneNum());
					System.out.println("------------------------------------------------------------------------");
			...
			for(int i = 0; i<Corona19.h3.rl.size(); i++) {
				...
				if(Corona19.h3.rl.get(i).getPhoneNum().substring(9).equals(find)) {
					...
					System.out.println("------------------------------------------------------------------------");
					System.out.println("예약자: " +Corona19.h3.rl.get(i).getName()+"님 " + "\t예약병원: " + Corona19.h3.name + "\t\t예약일: " + Corona19.h3.rl.get(i).getDayNum() + "\t전화번호: " + Corona19.h1.rl.get(i).getPhoneNum());
					System.out.println("------------------------------------------------------------------------");

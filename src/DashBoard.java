...
public class DashBoard {
	...
	public void dashboardstart() {
		...
		System.out.println("누적 확진자 수 : " + (Test.infectionList.size() + Cure.treatmentCompletedList.size())+ "명"); //확진자 리스트  + 치료자 리스트
		...
		System.out.println("백신 접종자 수 : " + (Cure.treatmentCompletedList.size() + Cure.antibodyList.size() + Cure.deathList.size())+ "명"); //치료자 리스트 + 항체생성 리스트 + 사망자 리스트

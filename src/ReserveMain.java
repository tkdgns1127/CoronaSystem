...
public class ReserveMain { // 메인클래스 여기서 실행
	...
	public void reserveStart() {
		...
		case 2:
			 ...
			 * System.out.println("1.서울대병원 2.아산병원 3.이화여대병원"); int num = scanner.nextInt();
			 * 
			 * if(num == 1) { reserve.searchSeat(Corona19.h1); //조회 메소드
			 * 
			 * }else if(num ==2) { reserve.searchSeat(Corona19.h2); //조회 메소드
			 * 
			 * }else {
			 * 

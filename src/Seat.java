...
class reserveseat {
	...
	public void Seat() { // 날짜예약
		 ...
		 * System.out.println("원하시는 날짜 :"); int Seattype = scanner.nextInt() - 1;
		 * System.out.println("원하시는 자리타입을 선택하세요. A,B"); System.out.println("좌석번호 :");
		 * int dayNum = scanner.nextInt() - 1 ; if(dayNum>31){
		 * System.out.println("잘못된 좌석번호 입니다. 다시 입력해주세요."); dayNum = scanner.nextInt()-1;
		 * } if(seats[Seattype][dayNum].equals(reserveName)){
		 * System.out.println("이미 예약된 자리입니다.다시 시도해주세요."); } seats[Seattype][dayNum] =
		 * (reserveName); break;
		 */
	}
